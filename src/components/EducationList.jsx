...
const EducationList = () => {
  ...
  useEffect(() => {
    axios
      .get("https://localhost:7039/api/Admin/Educations")
      .then((response) => {
  ...
  const uniqueUsers = Array.from(
    new Set(filteredEducations.map((edu) => edu.userID))
  )
      ...
      <div className="flex min-h-screen bg-base-200">
        ...
        <div className="w-1/6 bg-white shadow-lg p-6 rounded-lg">
          ...
          <ul className="menu bg-base-100 text-black rounded-box w-full text-lg">
            ...
            <li><NavLink to="/EducationList" className={({ isActive }) => isActive ? "hover:bg-gray-300 hover:text-black font-FontNoto font-bold bg-gray-200" : "hover:bg-yellow-100 hover:text-black font-FontNoto font-bold"}>การศึกษา</NavLink></li>
                    ...
                    <tr key={user.userID} className="hover:bg-gray-50">
                      ...
                      <td className="border px-4 py-2 text-center font-FontNoto">
                        <button
                          ...
                          onClick={() => navigate(`/EducationDetail/${user.userID}`)}
                        >
                          ดูรายละเอียด
                        </button>
                      </td>
